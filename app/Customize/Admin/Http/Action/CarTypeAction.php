...
class CarTypeAction extends Action
{
    public static function list(array $param)
    {
        ...
        $res = CarType::list($param , $order , config('app.limit'));
    ...
    public static function add(array $param)
    {
        ...
        $id = CarType::insertGetId(array_unit($param , [
            'name' ,
            'weight'
        ]));
