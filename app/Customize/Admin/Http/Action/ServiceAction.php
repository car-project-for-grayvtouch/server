...
class ServiceAction extends Action
{
    public static function list(array $param)
    {
        ...
        $res = Service::list($param , $order , config('app.limit'));
    ...
    public static function add(array $param)
    {
        ...
        $id = Service::insertGetId(array_unit($param , [
            'name' ,
            'weight'
        ]));
